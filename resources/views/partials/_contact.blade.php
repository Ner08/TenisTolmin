        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 xl:gap-16">
            <div>
                ...
                <div class="space-y-2.5 text-sm xl:text-base text-gray-400">
                    ...
                    <p>TRR: SI56 0475 3000 0388 292 NOVA KBM d.d.</p>
                    <p>Predsednik: Aleš Hvala</p>
                    <a href="mailto:info@tenis-tolmin.si" class="text-amber-400 hover:text-amber-300 font-medium transition-colors">info@tenis-tolmin.si</a>
                </div>
            </div>
            <div>
